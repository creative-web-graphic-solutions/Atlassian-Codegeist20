...
//                $sql = "INSERT IGNORE INTO $table (name,myphoto) VALUES('$name','$img_dir')";
               $sql = "INSERT INTO usermgt (empname, empid, description, groupto, email, role , photo) VALUES('$_POST[username]','$_POST[userid]', '$_POST[description]','$_POST[groupto]','$_POST[email]','$_POST[role]', '$img_dir')";
