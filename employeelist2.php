...
<!--							<a href="#deleteEmployeeModal" class="btn btn-danger" data-toggle="modal"><i class="material-icons">&#xE15C;</i> <span>Delete</span></a>						-->
            ...
            <?php
                while ($row = $result->fetch_assoc()): ?>
                    <tr>
                        <td><input style="border-color: transparent;width:20px"  name="empid" value="<?php echo $row['id'] ?>"> </td>
                        <td contenteditable="true"><input style="border-color: transparent;width:100px" value="<?php echo $row['employeename']; ?>" name="employeename"></td>
                        <td contenteditable="true"><input style="border-color: transparent;width:50px" value="<?php echo $row['employeeno']; ?>" name="employeeno"></td>
                        <td contenteditable="true"><input style="border-color: transparent;width:100px" value="<?php echo $row['joblocation']; ?>" name="joblocation"></td>
                        <td contenteditable="true"><input style="border-color: transparent;width:100px" value="<?php echo $row['dateofjoin']; ?>" name="dateofjoin"></td>
                        <td contenteditable="true"><input style="border-color: transparent;width:150px" value="<?php echo $row['designation']; ?>" name="designation"></td>
                        <td contenteditable="true"><input style="border-color: transparent;width:120px" value="<?php echo $row['contactnumber']; ?>" name="contactnumber"></td>
                        <td>
