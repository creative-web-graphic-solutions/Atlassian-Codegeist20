...
$(document).ready(function(){    
    var clickedid =  window.location.hash.substring(1);
...
xmlhttp.open("GET","http://atlassiancodegeist.com/myopentickets.php#"+id,true);
xmlhttp.send();
</script>    
...
-->
		...
		<div class="content-wrapper">
			<h3>My Open Ticket</h3>
            <div class="panel panel-default">
                <div class="panel-heading" style="background-color: lightgreen; border-bottom-style: outset">
                    <span > This Ticket is Open. You can reply to this ticket</span>
                </div>
...
<!--                    <input type="hidden" name="token" value="77d01df625b930d9b50a321b58595343102b92cc" />-->
        ...
        <div class="form-group col-sm-3">
            ...
            <select name="deptid" class="form-control" onchange="refreshCustomFields(this)">
...
<!--            </div>-->
            ...
            <textarea name="message"  id="inputMessage" rows="12" class="form-control markdown-editor md-input word_count" style="resize: vertical; margin: 10px; width: 90%"></textarea>
<!--
            <div class="md-footer">
                <div id="inputMessage-footer" class="markdown-editor-status" style="padding-left: 10px">
                    <div class="small-font" >lines: &nbsp;&nbsp;&nbsp;words: &nbsp;&nbsp;&nbsp;<span class="markdown-save">saved</span></div></div>
                </div>
-->
<!--
